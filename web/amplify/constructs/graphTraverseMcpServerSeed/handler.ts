...
const DEMO_AGENT_NAME = 'Knowledge Graph Demo';
const DEMO_MCP_SERVER_NAME = 'Knowledge Graph Tools';
  ...
  const created = await signedGraphqlRequest(
    ...
    }`,
    {
      input: {
        ...
        description: 'Demo agent proving the knowledge-graph TraverseGraph tool (issue #291) end-to-end.',
        enabled: true,
      },
    },
  );
