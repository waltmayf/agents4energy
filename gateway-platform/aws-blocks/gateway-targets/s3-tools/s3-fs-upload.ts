...
// Relative import here (unlike web/lib/s3-fs-upload.ts's "#lib/*" subpath
// import) — this is a standalone copy for gateway-platform (#536), not
// reachable from web/'s package.json "imports" map.
