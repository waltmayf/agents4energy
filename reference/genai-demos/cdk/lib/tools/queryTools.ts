...
const sqlQueryTool = {
  ...
  config: {
    ...
    description: 'Execute SQL via Amazon Athena. Waits for completion and returns results.',
    inputSchema: z.object({
      queryString: z.string().describe("SQL query"),
      database: z.string().optional().describe("Database name"),
      outputLocation: z.string().optional().describe("S3 output location"),
    })
  },
...
const listActionItemsTool = {
  ...
  config: {
    ...
    description: 'List action items with status and details.',
    inputSchema: z.object({
...
const listWorkoverJobsTool = {
  ...
  config: {
    ...
    description: 'List workover jobs with status, priority, and financial metrics.',
    inputSchema: z.object({
      limit: z.number().optional().describe('Max results (default: 100)'),
      nextToken: z.string().optional()
    })
...
const getWorkoverJobTool = {
  ...
  config: {
    ...
    description: 'Get a specific workover job by ID with financial metrics.',
    inputSchema: z.object({
