...
#
# The AgentCore harness/memory/gateway are built directly inside the agentStack
# CDK app (see web/amplify/backend.ts) and their ARNs land in amplify_outputs.json
# via backend.addOutput({ custom: {...} }) — no post-deploy wiring script is needed.
